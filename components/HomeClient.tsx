...
export default function HomeClient({ initialMenuData }: { initialMenuData: MenuItem[] }) {
  ...
  const allItems: MenuItem[] = initialMenuData;
  ...
  const todaySpecials = allItems.slice(0, 3);
          ...
          <div style={{ padding: "0 20px 24px" }}>
            <div style={{
              ...
              <div style={{ position: "absolute", right: "16px", top: "50%", transform: "translateY(-50%)", width: "86px", height: "86px", borderRadius: "50%", overflow: "hidden", border: "3px solid rgba(255,255,255,0.3)" }}>
                {todaySpecials[0] && <Image src={todaySpecials[0].image} alt="Today's special" fill className="object-cover" />}
              </div>
              <div style={{ width: "55%" }}>
